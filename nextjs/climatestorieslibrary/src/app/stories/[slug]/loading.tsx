      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-[color:var(--boxcolor)] rounded-[15px] backdrop-blur-sm border-[5px] border-[rgba(140,198,63,0.2)] p-8 animate-pulse">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <div className="h-4 bg-[rgba(140,198,63,0.2)] rounded w-24"></div>
            <div className="h-4 bg-[rgba(140,198,63,0.2)] rounded w-20"></div>
          </div>
          
          {/* Tags skeleton */}
          <div className="flex flex-wrap gap-2 mb-6">
            <div className="h-6 bg-[rgba(140,198,63,0.2)] rounded w-16"></div>
            <div className="h-6 bg-[rgba(140,198,63,0.2)] rounded w-20"></div>
            <div className="h-6 bg-[rgba(140,198,63,0.2)] rounded w-18"></div>
          </div>
